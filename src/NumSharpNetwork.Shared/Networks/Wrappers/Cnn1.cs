...
namespace NumSharpNetwork.Shared.Networks.Wrappers
{
    public class Cnn1 : NetworkWrapper
    {
        ...
        public Cnn1(int height, int width, int channels, int numClasses, OptimizerFactory optimizerFactory)
        {
            Convolution2DLayerSet convolution2DLayerSet1 = new Convolution2DLayerSet(channels, 32, optimizerFactory, false, false, name: "Convolution2DLayerSet-1");
